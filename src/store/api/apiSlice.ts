...
export const apiSlice = createApi({
    ...
    reducerPath: 'api',
    tagTypes: ['User', 'Withdrawal', 'Wallet', 'Loan', 'Notification', 'Ward', 'Chat', 'Post', 'AdminNotice', 'Auction', 'ShopProduct', 'ShopCategory', 'ShopOrder', 'ProductReview', 'ReviewableItem', 'StoreGuestUpgrade'],
    endpoints: () => ({}),
});
