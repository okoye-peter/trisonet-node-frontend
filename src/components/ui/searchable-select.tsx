        ...
        <AnimatePresence>
            {isOpen && (
                <motion.div
                    ...
                    style={dropdownStyle}
                    className="overflow-hidden rounded-[1.5rem] bg-white border border-zinc-100 shadow-2xl shadow-zinc-200/50"
                >
                    ...
                    <div className="max-h-[260px] overflow-y-auto overflow-x-hidden p-2 no-scrollbar">
